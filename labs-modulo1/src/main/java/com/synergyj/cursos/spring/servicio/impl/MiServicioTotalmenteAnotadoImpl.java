...
/**
 * @author Jorge Rodríguez Campos (jorge.rodriguez@synergyj.com) Observar que el id del Bean
 *         corresponde con el nombre de la interface en notacion camello. Se recomienda esta
 *         convención
 */
...
public class MiServicioTotalmenteAnotadoImpl implements MiServicio {
	...
	/**
	 * Nuevamente, Analizar la siguiente pregunta: ¿Donde está la definición del bean miDAO?,
	 * recordar que @Resource busca un bean con id miDAO como primer filtro.
	 */
	@Resource
	private MiDAO miDAO;
