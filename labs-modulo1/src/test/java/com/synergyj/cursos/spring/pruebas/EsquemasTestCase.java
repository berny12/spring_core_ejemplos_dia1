...
@ContextConfiguration(locations = "/esquemasAppContext.xml")
public class EsquemasTestCase {

	/**
	 * Logger para todas las instancias de la clase
	 */
	private static final Logger logger = LoggerFactory.getLogger(EsquemasTestCase.class);
